...
latlng: "37.7659063,-122.3896333"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use http://www.latlong.net/)
humandate: "Apr 11-12, 2018"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Caryn Johansen", "Jason Williams"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["John Baston", "Paola Castro", "Spyros Darmanis", "Jay Kasberger", "Sarah Kefayati", "Angela Oliveira Pisco", "Eric Waltari", "Olga Botvinnik (Host)"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: http://pad.software-carpentry.org/2018-04-11-czbiohub           # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
<div id="sql"> {% comment %} Start of 'SQLite' section. {% endcomment %}
  ...
  <p>
    ...
    <a href="http://www.sqlite.org/">SQLite</a> in our lessons. <b>Also - new 4/10/18</b>
